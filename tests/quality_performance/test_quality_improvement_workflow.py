...
class TestDataQualityValidator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_law_data = {
            'law_name': '?åÏä§??Î≤ïÎ•†',
            'full_text': '??Ï°?(Î™©Ï†Å) ??Î≤ïÏ? ?åÏä§?∏Î? ?ÑÌïú Î≤ïÎ•†?¥Îã§.\n??Ï°?(?ïÏùò) ??Î≤ïÏóê???¨Ïö©?òÎäî ?©Ïñ¥???ïÏùò???§ÏùåÍ≥?Í∞ôÎã§.',
            'articles': [
                {
                    'article_number': '??Ï°?,
                    'article_title': 'Î™©Ï†Å',
                    'article_content': '??Î≤ïÏ? ?åÏä§?∏Î? ?ÑÌïú Î≤ïÎ•†?¥Îã§.'
                },
                {
                    'article_number': '??Ï°?,
                    'article_title': '?ïÏùò',
                    'article_content': '??Î≤ïÏóê???¨Ïö©?òÎäî ?©Ïñ¥???ïÏùò???§ÏùåÍ≥?Í∞ôÎã§.'
                }
            ]
        }
