...
from lawfirm_langgraph.core.processing.extractors.extractors import (
    DocumentExtractor,
    QueryExtractor,
    ResponseExtractor
)
...
class TestDocumentExtractor:
    ...
    def test_extract_terms_from_empty_documents(self):
        """빈 문서에서 용어 추출 테스트"""
        docs = []
...
class TestReasoningExtractor:
    ...
    def test_extract_answer_from_response(self, reasoning_extractor):
        ...
        # extract_answer_from_response 메서드가 없으므로 extract_actual_answer 사용
