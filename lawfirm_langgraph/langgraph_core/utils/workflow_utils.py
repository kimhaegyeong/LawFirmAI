...
# 상위 프로젝트의 core 서비스를 import
import sys
import time
from pathlib import Path
from typing import Any, Dict, List, Optional, Tuple

from langgraph_core.data.extractors import ResponseExtractor
from langgraph_core.utils.state_definitions import LegalWorkflowState
from langgraph_core.utils.state_helpers import ensure_state_group, get_field, set_field
...
from langgraph_core.services.unified_prompt_manager import LegalDomain
