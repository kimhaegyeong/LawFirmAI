...
from langgraph_core.services.answer_formatter import AnswerFormatterHandler
from langgraph_core.services.answer_generator import AnswerGenerator
from langgraph_core.services.classification_handler import ClassificationHandler
from langgraph_core.services.context_builder import ContextBuilder
from langgraph_core.services.legal_data_connector_v2 import LegalDataConnectorV2
from langgraph_core.services.query_enhancer import QueryEnhancer
from langgraph_core.services.search_handler import SearchHandler
from langgraph_core.services.term_integration_system import TermIntegrator
from langgraph_core.services.unified_prompt_manager import (
    LegalDomain,
    ModelType,
    UnifiedPromptManager,
)
from langgraph_core.services.workflow_routes import WorkflowRoutes
from langgraph_core.utils.keyword_mapper import LegalKeywordMapper
from langgraph_core.utils.performance_optimizer import PerformanceOptimizer
...
try:
    from langgraph_core.services.answer_structure_enhancer import (
...
class EnhancedLegalQuestionWorkflow:
    ...
    def __init__(self, config: LangGraphConfig):
        ...
        try:
            from langgraph_core.services.semantic_search_engine_v2 import (
        ...
        try:
            from langgraph_core.services.conversation_manager import ConversationManager
            from langgraph_core.services.multi_turn_handler import (
        ...
        try:
            from langgraph_core.services.ai_keyword_generator import AIKeywordGenerator
        ...
        try:
            from langgraph_core.services.emotion_intent_analyzer import (
        ...
        try:
            from langgraph_core.services.legal_basis_validator import (
                LegalBasisValidator,
            )
        ...
        try:
            from langgraph_core.services.document_processor import (
    ...
    def generate_answer_enhanced(self, state: LegalWorkflowState) -> Dict[str, Any]:
        ...
        try:
            ...
            if not retrieved_docs or len(retrieved_docs) == 0:
                try:
                    from langgraph_core.models.node_wrappers import (
