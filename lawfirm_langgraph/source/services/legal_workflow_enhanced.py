...
from source.services.answer_formatter import AnswerFormatterHandler
from source.services.answer_generator import AnswerGenerator
...
from source.services.classification_handler import ClassificationHandler
from source.services.context_builder import ContextBuilder
from source.data.extractors import (
    DocumentExtractor,
    QueryExtractor,
    ResponseExtractor,
)
from source.utils.keyword_mapper import LegalKeywordMapper
from source.services.legal_data_connector_v2 import LegalDataConnectorV2
from source.models.node_wrappers import with_state_optimization
from source.utils.performance_optimizer import PerformanceOptimizer
...
from source.data.quality_validators import (
    AnswerValidator,
    ContextValidator,
    SearchValidator,
)
from source.services.query_enhancer import QueryEnhancer
from source.data.reasoning_extractor import ReasoningExtractor
from source.data.response_parsers import (
    AnswerParser,
    ClassificationParser,
    DocumentParser,
    QueryParser,
)
from source.services.search_handler import SearchHandler
...
from source.services.workflow_routes import WorkflowRoutes
    ...
    def generate_answer_enhanced(self, state: LegalWorkflowState) -> LegalWorkflowState:
        ...
        try:
            ...
            if not retrieved_docs or len(retrieved_docs) == 0:
                try:
                    from agents.node_wrappers import _global_search_results_cache
