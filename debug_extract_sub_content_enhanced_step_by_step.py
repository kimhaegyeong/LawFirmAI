#!/usr/bin/env python3
"""
Debug _extract_sub_content_enhanced method with step-by-step analysis
"""
...
def debug_extract_sub_content_enhanced_step_by_step():
    """Debug _extract_sub_content_enhanced method with step-by-step analysis."""
    ...
    print("=== Debugging _extract_sub_content_enhanced Step by Step ===")
    ...
    for match in paragraph_pattern.finditer(article_4_content):
        ...
        # Simulate _extract_sub_content_enhanced logic step by step
...
if __name__ == "__main__":
    debug_extract_sub_content_enhanced_step_by_step()