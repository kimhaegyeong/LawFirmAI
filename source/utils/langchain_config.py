...
class PromptTemplates:
    ...
    LEGAL_QA_TEMPLATE = """당신은 법률 전문가입니다. 주어진 법률 문서를 바탕으로 질문에 정확하고 도움이 되는 답변을 제공해주세요.
...
답변:"""
    ...
    LEGAL_ANALYSIS_TEMPLATE = """당신은 법률 분석 전문가입니다. 주어진 법률 문서를 분석하여 질문에 대한 상세한 분석을 제공해주세요.
...
분석:"""
    ...
    CONTRACT_REVIEW_TEMPLATE = """당신은 계약서 검토 전문가입니다. 주어진 계약서 내용을 검토하여 잠재적 위험요소와 개선사항을 제시해주세요.
