...
# 임시로 LegalCitationEnhancer import (순환 참조 방지)
try:
    from ...services.legal_citation_enhancer import LegalCitationEnhancer
except ImportError:
    # LegalCitationEnhancer가 없는 경우를 위한 임시 클래스
    class LegalCitationEnhancer:
        def enhance_text_with_citations(self, text: str):
            return {'citations': [], 'citation_count': 0, 'enhanced_text': text}
