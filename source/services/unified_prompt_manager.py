...
- "~입니다", "귀하" 같은 과도하게 격식적인 표현 대신, "~예요", "질문하신" 등 자연스러운 존댓말을 사용하세요
- 질문을 다시 반복하지 마세요
...
- **실무적 조언**: 실행 가능한 구체적인 방안 제시
- **주의사항**: 법적 리스크 및 주의할 점 (필요시에만)
