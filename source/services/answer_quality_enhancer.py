...
from .answer_structure_enhancer import QuestionType as StructureQuestionType
...
# 개별 품질 향상 모듈들 import
from .unified_prompt_manager import LegalDomain, QuestionType, UnifiedPromptManager
from .validation.legal_term_validator import LegalTermValidator
