...
class ContractQueryHandler:
    """계약서 관련 질문 처리기"""
    
    def __init__(self, interactive_contract_assistant, integrated_session_manager):
        self.interactive_contract_assistant = interactive_contract_assistant
        self.integrated_session_manager = integrated_session_manager
        self.logger = logging.getLogger(__name__)
    
    def is_contract_related_query(self, message: str) -> bool:
        """계약서 관련 질문인지 감지"""
        try:
    ...
    async def handle_interactive_contract_query(self, message: str, session_id: str, user_id: str) -> Dict[str, Any]:
        """대화형 계약서 질문 처리"""
        try:
