...
# -*- coding: utf-8 -*-
"""
대규모 Q&A 데이터셋 생성 스크립트

목표: 3,000개 이상의 Q&A 쌍 생성
- 모든 데이터 소스 활용
- 다양한 질문 패턴 생성
- 품질 검증 강화
"""
...
LARGE_SCALE_QA_TEMPLATES = {
    'law_definition': [
        ...
        "{law_name}의 입법 취지는 무엇인가요?",
        "{law_name}의 핵심 개념은 무엇인가요?",
        "{law_name}이 보호하는 것은 무엇인가요?",
        "{law_name}의 법적 근거는 무엇인가요?",
        "{law_name}의 적용 대상은 누구인가요?",
        "{law_name}의 주요 원칙은 무엇인가요?",
        "{law_name}의 법적 효과는 무엇인가요?"
    ],
    'law_article': [
        ...
        "제{article}조의 적용 범위는 어떻게 되나요?",
        "제{article}조의 요구사항은 무엇인가요?",
        "제{article}조의 금지사항은 무엇인가요?",
        "제{article}조의 허용사항은 무엇인가요?",
        "제{article}조의 절차는 어떻게 되나요?",
        "제{article}조의 기준은 무엇인가요?",
        "제{article}조의 조건은 무엇인가요?"
    ],
    'law_article_title': [
        ...
        "제{article}조의 명칭은 무엇인가요?",
        "제{article}조의 표제는 무엇인가요?"
    ],
    'law_keyword': [
        ...
        "{keyword}의 법적 성격은 무엇인가요?",
        "{keyword}의 법적 요구사항은 무엇인가요?",
        "{keyword}의 법적 절차는 어떻게 되나요?",
        "{keyword}의 법적 기준은 무엇인가요?",
        "{keyword}의 법적 조건은 무엇인가요?",
        "{keyword}의 법적 금지는 무엇인가요?",
        "{keyword}의 법적 허용은 무엇인가요?"
    ],
    'precedent_issue': [
        ...
        "사건의 핵심은 무엇인가요?",
        "이 사건의 법적 쟁점은 무엇인가요?",
        "사건에서 다룬 핵심 문제는 무엇인가요?",
        "법원이 해결해야 할 문제는 무엇인가요?",
        "사건의 주요 쟁점은 무엇인가요?",
        "이 사건의 법적 문제는 무엇인가요?",
        "사건의 핵심 법적 쟁점은 무엇인가요?",
        "이 사건의 주요 법적 문제는 무엇인가요?",
        "사건에서 제기된 문제는 무엇인가요?"
    ],
    'precedent_decision': [
    ...
    'constitutional_issue': [
        ...
        "사건의 헌법적 의미는 무엇인가요?",
        "이 사건의 기본권 문제는 무엇인가요?",
        "헌법재판소가 판단한 대상은 무엇인가요?",
        "사건의 헌법적 쟁점은 무엇인가요?",
        "이 사건의 헌법적 문제는 무엇인가요?",
        "헌법재판소가 해결한 문제는 무엇인가요?",
        "사건의 헌법적 핵심은 무엇인가요?"
    ],
    'constitutional_decision': [
        ...
        "헌법재판소의 결정 요지는 무엇인가요?",
        "헌법재판소가 내린 결론은 무엇인가요?",
        "이 사건의 헌법재판소 결정은 무엇인가요?",
        "헌법재판소의 판단 내용은 무엇인가요?",
        "사건의 헌법재판소 결정을 설명해주세요.",
        "헌법재판소가 내린 판단은 무엇인가요?",
        "이 사건의 헌법적 결정은 무엇인가요?",
        "헌법재판소의 결론은 무엇인가요?",
        "사건의 헌법적 판단은 무엇인가요?",
        "헌법재판소의 결정 내용은 무엇인가요?",
        "이 사건의 헌법재판소 판단은 무엇인가요?"
    ],
    'interpretation_question': [
        ...
        "{topic}에 대한 법적 해석은 무엇인가요?",
        "{topic}의 해석 기준은 무엇인가요?",
        "{topic}에 대한 정부 해석은 무엇인가요?",
        "{topic}의 법령 해석은 어떻게 되나요?",
        "{topic}에 대한 공식적 해석은 무엇인가요?",
        "{topic}의 법적 해석은 무엇인가요?",
        "{topic}에 대한 법령적 해석은 무엇인가요?",
        "{topic}의 해석 내용은 무엇인가요?",
        "{topic}에 대한 법적 해석 내용은 무엇인가요?"
    ],
    'general_legal': [
        "{keyword}에 대한 법적 근거는 무엇인가요?",
        "{keyword}의 법적 요건은 무엇인가요?",
...
LARGE_SCALE_ANSWER_TEMPLATES = {
    'law_definition': [
        ...
        "{law_name}은 {definition}을 보장하는 법률입니다.",
        "{law_name}는 {definition}에 관한 법적 규정입니다.",
        "{law_name}의 기본 원칙은 {definition}입니다.",
        "{law_name}은 {definition}을 실현하는 법률입니다."
    ],
    'law_article': [
        ...
        "제{article}조에 따르면 {content}입니다.",
        "제{article}조에서 규정하는 바는 {content}입니다.",
        "제{article}조의 핵심 내용은 {content}입니다.",
        "제{article}조에서 명시하는 것은 {content}입니다."
    ],
    'law_article_title': [
        ...
        "제{article}조의 명칭은 '{title}'입니다.",
        "제{article}조의 표제는 '{title}'입니다."
    ],
    'law_keyword': [
        ...
        "{keyword}의 법적 개념은 {content}입니다.",
        "{keyword}는 {content}로 정의됩니다.",
        "{keyword}의 법적 내용은 {content}입니다.",
        "{keyword}에 대한 법적 규정은 {content}입니다.",
        "{keyword}의 법적 정의는 {content}입니다."
    ],
    'precedent_issue': [
        ...
        "법적 쟁점은 {issue}입니다.",
        "사건의 핵심은 {issue}입니다.",
        "이 사건의 법적 문제는 {issue}입니다.",
        "사건에서 제기된 문제는 {issue}입니다.",
        "법원이 해결해야 할 문제는 {issue}입니다."
    ],
    'precedent_decision': [
        ...
        "이 사건의 판결 내용은 {decision}입니다.",
        "법원이 내린 판단은 {decision}입니다.",
        "사건의 판결 요지는 {decision}입니다.",
        "법원의 결론은 {decision}입니다."
    ],
    'precedent_court': [
        ...
        "이 사건의 담당 법원은 {court}입니다.",
        "판결을 내린 법원은 {court}입니다.",
        "사건을 처리한 법원은 {court}입니다.",
        "이 사건의 법원은 {court}입니다.",
        "판결을 내린 법원은 {court}입니다.",
        "사건을 담당한 법원은 {court}입니다."
    ],
    'precedent_date': [
        "{case_name} 사건의 판결일은 {date}입니다.",
        "이 사건의 판결 날짜는 {date}입니다.",
        "판결이 내려진 날짜는 {date}입니다.",
        "사건의 판결일은 {date}입니다.",
        "이 사건이 판결된 날짜는 {date}입니다.",
        "판결일은 {date}입니다.",
        "사건의 판결 시기는 {date}입니다.",
        "이 사건의 판결 시점은 {date}입니다."
    ],
    'precedent_case_number': [
        "{case_name} 사건의 사건번호는 {case_number}입니다.",
        "이 사건의 사건번호는 {case_number}입니다.",
        "사건번호는 {case_number}입니다.",
        "이 사건의 번호는 {case_number}입니다.",
        "사건의 번호는 {case_number}입니다.",
        "이 사건의 사건번호는 {case_number}입니다.",
        "사건의 고유번호는 {case_number}입니다.",
        "이 사건의 식별번호는 {case_number}입니다."
    ],
    'constitutional_issue': [
        ...
        "헌법적 쟁점은 {issue}입니다.",
        "기본권 문제는 {issue}입니다.",
        "이 사건의 헌법적 쟁점은 {issue}입니다.",
        "헌법재판소가 다룬 문제는 {issue}입니다.",
        "사건의 헌법적 의미는 {issue}입니다.",
        "이 사건의 기본권 문제는 {issue}입니다."
    ],
    'constitutional_decision': [
        ...
        "이 사건의 헌법재판소 결정은 {decision}입니다.",
        "헌법재판소의 판단 내용은 {decision}입니다.",
        "사건의 헌법재판소 결정은 {decision}입니다.",
        "헌법재판소가 내린 판단은 {decision}입니다."
    ],
    'interpretation_question': [
        ...
        "{topic}에 대한 법적 해석은 {interpretation}입니다.",
        "{topic}의 해석 기준은 {interpretation}입니다.",
        "{topic}에 대한 정부 해석은 {interpretation}입니다.",
        "{topic}의 법령 해석은 {interpretation}입니다."
    ],
    'general_legal': [
        ...
        "{keyword}의 법적 성격은 {nature}입니다.",
        "{keyword}의 법적 지위는 {status}입니다.",
        "{keyword}의 법적 요구사항은 {requirement}입니다.",
        "{keyword}의 법적 절차는 {procedure}입니다."
    ]
}
...
class LargeScaleQADatasetGenerator:
    ...
    def generate_law_qa_pairs(self, law_data: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if cleaned_content:
                ...
                if definition:
                    for template in LARGE_SCALE_QA_TEMPLATES['law_definition'][:8]:  # 처음 8개 사용
            ...
            # 2. 조문별 Q&A (더 많은 패턴)
            for article in articles[:15]:  # 처음 15개 조문 사용
            ...
            for keyword in keywords[:15]:  # 상위 15개 키워드 사용
    ...
    def generate_dataset(self, data_dir: str = "data/processed", output_dir: str = "data/qa_dataset") -> bool:
        """전체 Q&A 데이터셋 생성 (대규모 버전)"""
        try:
            data_path = Path(data_dir)
            output_path = Path(output_dir)
            output_path.mkdir(parents=True, exist_ok=True)
            
            self.logger.info("대규모 Q&A 데이터셋 생성 시작...")
            ...
            self.logger.info(f"대규모 Q&A 데이터셋 생성 완료: {len(self.qa_pairs)}개 쌍")
            return True
...
def main():
    ...
    if success:
        logger.info("대규모 Q&A 데이터셋 생성이 완료되었습니다.")
    else:
        logger.error("대규모 Q&A 데이터셋 생성에 실패했습니다.")
