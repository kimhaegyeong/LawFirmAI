...
def main():
    ...
    parser = argparse.ArgumentParser(description="ML 강화 벡터 ?�베???�성�?(최적??버전)")
    parser.add_argument("--input", required=True, help="?�력 ?�렉?�리")
    parser.add_argument("--output", required=True, help="출력 ?�렉?�리")
    parser.add_argument("--batch-size", type=int, default=200, help="배치 ?�기 (기본�? 200)")
    parser.add_argument("--max-workers", type=int, default=None, help="최�? ?�커 ??)
