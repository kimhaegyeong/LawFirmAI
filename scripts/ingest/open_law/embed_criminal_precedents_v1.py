...
_PROJECT_ROOT = _CURRENT_FILE.parents[3]  # scripts/ingest/open_law -> 프로젝트 루트
...
def main():
    ...
    # 형법 판례 임베딩 생성 (이미 임베딩된 항목은 자동으로 건너뜀)
