...
| sort | string | 정렬옵션lasc : 사건명 오름차순 (default)ldes : 사건명 내림차순dasc : 의결일자 오름차순ddes : 의결일자 내림차순nasc : 사건번호 오름차순ndes : 사건번호 내림차순 |
| popYn | string | 상세화면 팝업창 여부(팝업창으로 띄우고 싶을 때만 'popYn=Y') |

샘플 URL

1. https://www.law.go.kr/DRF/lawSearch.do?OC=test&target=eiac&type=HTML
2. https://www.law.go.kr/DRF/lawSearch.do?OC=test&target=eiac&type=XML
3. https://www.law.go.kr/DRF/lawSearch.do?OC=test&target=eiac&type=JSON
