...
| type | char(필수) | 출력 형태 HTML/XML/JSON생략시 기본값: XML |
| search | int | 검색범위 (기본 : 1 법령명) 2 : 본문검색 |
| query | string | 법령명에서 검색을 원하는 질의(정확한 검색을 위한 문자열 검색 query="자동차") |
| nw | int | 1: 연혁, 2: 시행예정, 3: 현행 (기본값: 전체)연혁+예정 : nw=1,2예정+현행 : nw=2,3연혁+현행 : nw=1,3연혁+예정+현행 : nw=1,2,3 |
...
1. http://www.law.go.kr/DRF/lawSearch.do?OC=test&target=eflaw&type=XML
2. http://www.law.go.kr/DRF/lawSearch.do?OC=test&target=eflaw&type=HTML
3. http://www.law.go.kr/DRF/lawSearch.do?OC=test&target=eflaw&type=JSON
4. http://www.law.go.kr/DRF/lawSearch.do?OC=test&target=eflaw&query=자동차관리법
5. http://www.law.go.kr/DRF/lawSearch.do?OC=test&target=eflaw&type=XML&sort=ddes
6. http://www.law.go.kr/DRF/lawSearch.do?OC=test&target=eflaw&type=XML&org=1613000
7. http://www.law.go.kr/DRF/lawSearch.do?OC=test&target=eflaw&type=XML&LID=830
