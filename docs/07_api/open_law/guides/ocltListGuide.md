...
| sort | string | 정렬옵션lasc : 제목 오름차순 (default)ldes : 제목 내림차순 |
| popYn | string | 상세화면 팝업창 여부(팝업창으로 띄우고 싶을 때만 'popYn=Y') |

샘플 URL

1. https://www.law.go.kr/DRF/lawSearch.do?OC=test&target=oclt&type=HTML
2. https://www.law.go.kr/DRF/lawSearch.do?OC=test&target=oclt&type=XML
3. https://www.law.go.kr/DRF/lawSearch.do?OC=test&target=oclt&type=JSON
