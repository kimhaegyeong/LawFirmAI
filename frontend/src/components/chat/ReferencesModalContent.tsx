  ...
  const counts = useMemo(() => {
    ...
    if (import.meta.env.DEV && propSourcesByType) {
      console.debug('[ReferencesModalContent] Type counts:', {
        ...
        total: allCount,
        sourcesByType: {
          statute_article: propSourcesByType.statute_article?.length || 0,
          case_paragraph: propSourcesByType.case_paragraph?.length || 0,
          decision_paragraph: propSourcesByType.decision_paragraph?.length || 0,
          interpretation_paragraph: propSourcesByType.interpretation_paragraph?.length || 0,
          regulation_paragraph: propSourcesByType.regulation_paragraph?.length || 0,
        },
