    ...
    if (initialSelectedReferenceId && effectiveSourcesDetail.length > 0 && !selectedReference) {
      ...
      if (foundDetail) {
        const legalRef: LegalReferenceDetail = {
          ...
          case_number: (foundDetail.case_number ? String(foundDetail.case_number) : undefined) || (foundDetail.metadata?.case_number ? String(foundDetail.metadata.case_number) : undefined) || (foundDetail.metadata?.doc_id ? String(foundDetail.metadata.doc_id) : undefined),
          article_number: foundDetail.article_no ? `제${foundDetail.article_no}조` : undefined,
          decision_number: (foundDetail.decision_number ? String(foundDetail.decision_number) : undefined) || (foundDetail.metadata?.decision_number ? String(foundDetail.metadata.decision_number) : undefined),
          interpretation_number: (foundDetail.interpretation_number ? String(foundDetail.interpretation_number) : undefined) || (foundDetail.metadata?.interpretation_number ? String(foundDetail.metadata.interpretation_number) : undefined),
